...
public class KakaoUriBuilderService {
    ...
    public URI buildUriByCategorySearch(double latitude, double longitude, double radius, String category) {
        ...
        UriComponentsBuilder uriBuilder = UriComponentsBuilder.fromUriString(KAKAO_LOCAL_CATEGORY_ADDRESS_URL);
        ...
        log.info("[KakaoUriSearchService buildUrlByCategorySearch] uri: {}", uri);
